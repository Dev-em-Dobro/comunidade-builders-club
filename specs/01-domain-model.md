...
| **Notificação** | Aviso in-app (comentário, reação, resposta, menção). E-mail agrupado de resposta: F073. |
...
| **Live semanal** | Encontro semanal ao vivo, benefício da oferta **Elite** (regra padrão: terça 20h, com exceção pontual). Tem gravação. Aviso: lembrete por e-mail na véspera e pouco antes (F079). Desde a F099 **não tem faixa no Club** — o aviso é só por e-mail. |
| **Bastidores** | Live **aberta a qualquer pessoa**, toda quinta às 20h, no Zoom (F099). Não é entrega de plano: é topo de funil. Quem assiste **não leva gravação** — gravação é benefício de aluno pagante. Aviso: faixa no topo do Club, que leva ao grupo de WhatsApp. Não confundir com a Live semanal; "live", sozinho, é ambíguo e não deve ser usado. |
