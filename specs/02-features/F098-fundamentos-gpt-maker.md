...
2. Quatro aulas em vídeo na ordem do folder, com `video_external_id` do
   Panda e descrições no seed + `aulas-descricoes-data.mts`. A quinta
   aula (texto) é a [F099](F099-aula-texto-precificacao-gpt-maker.md).
...
| 5 | `como-cobrar-por-agentes` | Como cobrar por agentes no GPT Maker | — (texto · F099) |

## Critérios

1. Sidebar de Fundamentos mostra o bloco **Fundamentos GPT Maker**
2. Player abre as 4 aulas em vídeo na ordem acima; a 5ª é texto (F099)
...
- Conteúdo avançado de GPT Maker além desses 4 vídeos + a aula de
  precificação em texto (F099)
