# F028 — Aulas: capa, lista estilo catálogo e player em modal

## Status
Implementado

## Objetivo
Módulo Aulas com capa, lista no padrão do dashboard Panda, player em
modal, sync da pasta Panda e remoção com confirmação no admin.
